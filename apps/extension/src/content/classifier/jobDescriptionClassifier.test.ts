...
import { classifyJobDescription, classifyParagraphs, classifyDocument } from './jobDescriptionClassifier';
...
describe('Job Description Classifier', () => {
  ...
  describe('classifyParagraphs', () => {
    it('should return all paragraphs but mark short ones as not examined', () => {
      const paragraphs = [
        'Short',  // 5 chars - not examined
        'You will be responsible for managing projects and coordinating with teams.',
        'Another',  // 7 chars - not examined
      ];
